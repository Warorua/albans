                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6">
                                    <div class="input-group">
                                        ...
                                        <select id="ajaxResult" onchange="ajaxClassStuAndPar(this.value)" name="receiver" class="form-control select2me" data-placeholder="<?php echo lang('select'); ?>"  data-validation="required">
                                        </select>
                                    </div>
                                </div>
                            </div>
...
<script>
    ...
    function ajaxClassStuAndPar(str) {
        var xmlhttp;
