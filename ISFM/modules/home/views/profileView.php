                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="clearfix margin-top-10">
                                                        <div class="alert alert-danger">
                                                            <strong>Note:</strong> At first you have to check you file name because you can not use these character <b> ~!@#$%^&()_+}{ </b> in your file name. You have to use fresh file name example: <b>abcd.png</b> and you don't use like this <b>ab_c#d.png</b> .If you use that character It will make an error and not show your picture.  
							</div>
                                                </div>
                                            </div>
                                            <div class="margiv-top-10">
