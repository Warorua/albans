...
<?php } ?>
                                                ...
                                                <label for="startTime">Start Time</label>
                                                    <input type="time" class="form-control" placeholder="<?php echo lang('clas_start_time_plas'); ?>" name="startTime" data-validation="required" data-validation-error-msg="">
                                                </div>
                                                <div class="col-md-2 routineFildMarginBottom">
                                                    <label for="endTime">End Time</label>
                                                    <input type="time" class="form-control" placeholder="<?php echo lang('clas_end_time_plas'); ?>" name="endTime" data-validation="required" data-validation-error-msg="">
                                                </div>
                                                <div class="col-md-2 routineFildMarginBottom">
