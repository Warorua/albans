                                ...
                                <?php foreach ($parents as $row) { ?>
                                    <tr>
                                        ...
                                        <td>
                                                ...
                                                <a class="btn btn-xs red" href="index.php/parents/deleteParents?painid=<?php echo $row['id']; ?>&puid=<?php echo $row['user_id']; ?>" onClick="javascript:return confirm('<?php echo lang('par_aysywtdtgp'); ?>')"> <i class="fa fa-trash-o"></i> <?php echo lang('delete'); ?> </a>
                                        </td>
                                        <?php } ?>
                                    </tr>
                                <?php } ?>
