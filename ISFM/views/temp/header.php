...
<html lang="en" >
    ...
    <head>
        ...
        <link rel="shortcut icon" href="assets/admin/layout/img/log.png" type="images/x-icon" />
        ...
        <link id="style_color" href="assets/admin/layout/css/themes/darkblue.min.css" rel="stylesheet" type="text/css"/>
    ...
    <body class="page-header-fixed page-quick-sidebar-over-content page-header-fixed-mobile page-footer-fixed1">
        ...
        <div class="page-header navbar navbar-fixed-top">
            ...
            <div class="page-header-inner">
                ...
                <div class="page-logo">
                    <a href="index.html">
                        <img src="assets/admin/layout/img/log.png" alt="logo" height="80px" class="logo-default"/>
                    </a>
                ...
                $userId = $user->id;
                $query = $this->db->query("SELECT * FROM student_info WHERE student_id=$user->child_id")->row();
                if($user->child_id != 0){
                    $child_id = $query->user_id;
                }
                else{
                    $child_id = $userId;
                }
                                            ...
                                            <ul class="sub-menu">
                                                ...
                                                <?php } if ($this->common->user_access('stu_own_info', $userId)) { ?>
                                                    <li class="<?php echo $studentsInfo; ?>">
                                                        <a href="index.php/students/studentsInfo?uisd=<?php echo $child_id; ?>">
